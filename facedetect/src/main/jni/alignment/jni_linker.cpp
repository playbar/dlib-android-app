...
JNIEXPORT void JNICALL
Java_com_face_landmark_FaceTracker_nativeDestroyFaceTracker(JNIEnv *env, jobject instance)
{
    if (faceTracker != NULL) {
        delete faceTracker;
        faceTracker = NULL;
...
Java_com_face_landmark_FaceTracker_nativeTrackFace(JNIEnv *env,
                                                   jobject instance,
                                                   jbyteArray frame_,
                                                   jint width,
                                                   jint height,
...
JNIEXPORT void JNICALL
Java_com_face_landmark_FaceTracker_nativeReset(JNIEnv *env, jobject instance)
{
    if (faceTracker != NULL)
    {
        faceTracker->Reset();
